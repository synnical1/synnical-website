const require_index = require("../useInterval/index.js");
...
const useCountDown = (time, format = getHMSTime, callback) => {
	const [remainTime, setRemainTime] = (0, react.useState)(time);
	const [delay, setDelay] = (0, react.useState)(1e3);
	require_index.useInterval(() => {
		if (remainTime <= 0) {
			setDelay(null);
			return;
		}
