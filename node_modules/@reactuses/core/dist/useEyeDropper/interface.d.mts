//#region src/useEyeDropper/interface.d.ts
/**
 * @title useEyeDropper
 * @returns 包含以下元素的元组：
 * - 浏览器是否支持该特性。
 ...
 * - 打開顏色選擇器的函數。
 */
type UseEyeDropper = () => readonly [boolean, (options?: UseEyeDropperOpenOptions) => Promise<UseEyeDropperOpenReturnType>];
/**
...
//#endregion
export { UseEyeDropper, UseEyeDropperOpenOptions, UseEyeDropperOpenReturnType };