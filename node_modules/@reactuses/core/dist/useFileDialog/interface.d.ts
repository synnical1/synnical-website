//#region src/useFileDialog/interface.d.ts
/**
 * @title useFileDialog
 * @returns 包含以下元素的元组：
 * - 文件数组。
 ...
 * - 重設函數。
 */
type UseFileDialog = (options?: UseFileDialogOptions) => readonly [FileList | null, (localOptions?: Partial<UseFileDialogOptions>) => Promise<FileList | null | undefined>, () => void];
/**
...
//#endregion
export { UseFileDialog, UseFileDialogOptions };