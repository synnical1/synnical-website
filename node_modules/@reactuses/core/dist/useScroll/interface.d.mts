...
//#region src/useScroll/interface.d.ts
/**
 * @title useScroll
 * @returns 包含以下元素的元组：
 * - x 值。
 ...
 * @en optional params
 */
options?: UseScrollOptions) => readonly [number, number, boolean, UseScrollArrivedState, UseScrollDirection];
/**
...
//#endregion
export { UseScroll, UseScrollArrivedState, UseScrollDirection, UseScrollOffset, UseScrollOptions };