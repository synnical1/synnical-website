//#region src/useCounter/interface.d.ts
/**
 * @title useCounter
 ...
 */
min?: number | null) => readonly [number, (newState: number | ((prev: number) => number) | (() => number)) => void, (delta?: number) => void, (delta?: number) => void, () => void];
//#endregion
export { UseCounter };