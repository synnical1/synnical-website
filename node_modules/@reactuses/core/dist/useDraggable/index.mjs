...
const useDraggable = (target, options = {}) => {
	...
	const [position, setPositon] = useState((_options$initialValue = options.initialValue) !== null && _options$initialValue !== void 0 ? _options$initialValue : {
		x: 0,
		y: 0
	});
