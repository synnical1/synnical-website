const require_domTarget = require("./domTarget.js");
let react = require("react");
//#region src/utils/useStableTarget.ts
/**
...
function useStableTarget(target, defaultElement) {
	...
	let stableKey;
	if (!target) stableKey = defaultElement !== null && defaultElement !== void 0 ? defaultElement : null;
	else if (typeof target === "object" && "current" in target) stableKey = target;
	else stableKey = require_domTarget.getTargetElement(target, defaultElement);
	return {
...
//#endregion
exports.useStableTarget = useStableTarget;
