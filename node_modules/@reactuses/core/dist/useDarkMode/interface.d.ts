//#region src/useDarkMode/interface.d.ts
/**
 ...
 * - 更新黑暗狀態的功能。
 */
type UseDarkMode = (options: UseDarkOptions) => readonly [boolean | null, () => void, React.Dispatch<React.SetStateAction<boolean | null>>];
//#endregion
export { UseDarkMode, UseDarkOptions };