//#region src/useScriptTag/interface.d.ts
/**
 * @title useScriptTag
 * @returns 包含以下元素的元组：
 * - 用来加载资源的 html 元素。
 ...
 * @en optional params
 */
options?: UseScriptTagOptions) => readonly [HTMLScriptElement | null, UseScriptTagStatus, (waitForScriptLoad?: boolean) => Promise<HTMLScriptElement | boolean>, () => void];
/**
...
//#endregion
export { UseScriptTag, UseScriptTagOptions, UseScriptTagStatus };