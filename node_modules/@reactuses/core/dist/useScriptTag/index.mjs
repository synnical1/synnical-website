...
const useScriptTag = (src, onLoaded = noop, options = defaultOptions) => {
	...
	*/
	...
	useMount(() => {
		if (immediate && !manual) load().catch(noop);
	});
	useUnmount(() => {
		if (!manual) unload();
	});
