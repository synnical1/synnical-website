//#region src/useColorMode/interface.d.ts
/**
 ...
 * - 循環切換可用模式的函數。
 */
type UseColorMode<T extends string = string> = (options: UseColorModeOptions<T>) => readonly [T | null, React.Dispatch<React.SetStateAction<T | null>>, () => void];
//#endregion
export { UseColorMode, UseColorModeOptions };